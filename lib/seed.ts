...
const redis = new Redis({
    url: 'https://pleasant-gobbler-43435.upstash.io',
    token: 'AamrAAIncDE5NGU2NjkwOGZlNTg0MTQxODY3NjBkMWEwOTliZDYzNnAxNDM0MzU',
})
...
cityList.forEach((country) => {
    ...
    const populateDb = async () => {
        try {
            ...
            console.log(`Successfully added prefixes for ${term}`);
        } catch (error) {
            console.error(`Failed to add prefixes for ${term}`, error);
        }
    };
